 ...
 * Name: Thao Truong
 * Program Name: Lab3
 * Description: create a project folder called Lab3 that contains a package named atruck that will
...
public class GreenTruck extends AbstractTruck {
	public GreenTruck (Graphics graphic) {
		System.out.println("Green Truck is activated");
